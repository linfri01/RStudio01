...
usethis::use_git_config(user.name = "Linda Frigioni", user.email = "linda.frigioni@student.univaq.it")
...
# --- 8)  Collegare il repository docente come upstream al proprio repository GitHub ---
